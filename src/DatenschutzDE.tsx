export function DatenschutzDE() { return (<div className="legal-container w-full max-w-4xl py-24 px-6 md:px-14 text-white">
    ...
    <section className="legal-content card-glass">
      <article className="legal-text">
        ...
        <p>Ich unterhalte ein Profil auf Telegram. Betreiber ist Telegram FZ-LLC, Business Central Towers, Tower A, Office 1003/1004, Dubai, Vereinigte Arabische Emirate. Die Datenschutzerklärung ist hier abrufbar:</p>
